...
mmseqs_path = os.path.join(datasets_scanNet_path, 'mmseqs')
mafft_path = os.path.join(datasets_scanNet_path, 'mafft')
ASA_path = os.path.join(datasets_scanNet_path, 'ASA')
ImerFiles_path = os.path.join(datasets_scanNet_path, 'ImerFiles')
